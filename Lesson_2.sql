...
USE Lesson_2; -- Подключаемся к конкретной БД
...
INSERT INTO producers (name_producer) 
VALUES
  ("Гай Ричи"),
  ("Квентин Тарантино"),
  ("Кристофер Нолан");
...
CREATE TABLE users (
  ...
  name_us VARCHAR(255) COMMENT 'Имя покупателя',
...
INSERT INTO users (name_us, birthday_at, created_at, updated_at) VALUES
